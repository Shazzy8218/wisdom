// Omnipresent Owl Widget — floating chat bubble accessible from every page
...
export default function OwlWidget() {
  ...
  const handleNudgeTap = () => {
    if (!nudge) return;
    setIsOpen(true);
    dismiss();
    setTimeout(() => sendMessage(nudge.prompt), 100);
  };
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
              ...
              <div className="flex items-center gap-1">
                <button onClick={handleOpenFull}
                  className="h-7 w-7 rounded-lg hover:bg-muted/50 flex items-center justify-center transition-colors"
