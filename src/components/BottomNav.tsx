import { BookOpen, BookMarked, User, MoreHorizontal, Gamepad2, Target, Wallet, Settings, Zap, HelpCircle, Newspaper, X, Hexagon } from "lucide-react";
...
const PRIMARY_NAV = [
  ...
  { to: "/nexus", icon: Hexagon, label: "Nexus" },
