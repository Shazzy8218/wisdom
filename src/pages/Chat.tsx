...
import { Send, Sparkles, Bot, Square, RotateCcw, ChevronDown, Shield } from "lucide-react";
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "welcome",
      role: "assistant",
      content: "Welcome to **Wisdom AI Coach**. I'm your personal AI tutor — ask me anything about AI, prompting, workflows, or any topic you're learning.\n\n**What would you like to learn today?**",
    },
  ]);
