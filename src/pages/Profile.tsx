...
import { User, Wallet, BookOpen, Settings, Crown, ChevronRight, Sparkles, Wrench } from "lucide-react";
import { Link } from "react-router-dom";

const MENU_ITEMS = [
  { icon: Wallet, label: "Wisdom Wallet", subtitle: "142 tokens", to: "/wallet" },
  { icon: Sparkles, label: "Token Store", subtitle: "Unlock content", to: "/store" },
  { icon: BookOpen, label: "My Learning", subtitle: "11 lessons completed", to: "/library" },
  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="grid grid-cols-3 gap-3 px-5 mb-6">
        {[{ val: "142", label: "Tokens" }, { val: "7", label: "Streak" }, { val: "5%", label: "Mastery" }].map((s, i) => (
