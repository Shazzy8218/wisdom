...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'hero': ['3.5rem', { lineHeight: '1', letterSpacing: '-0.03em', fontWeight: '700' }],
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(355 78% 50% / 0.15)" },
          "50%": { boxShadow: "0 0 40px hsl(355 78% 50% / 0.3)" },
        },
        "count-up": {
      ...
      animation: {
        ...
        "number-tick": "number-tick 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards",
      },
    },
  },
